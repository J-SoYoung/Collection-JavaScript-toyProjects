      ...
      <KeyboardSection onClick={handleMouseClick}>
        <div>
          ...
          <Row>
            ...
            <Key align={true} className="f_key" data-code="Quote" data-val="'">
              <span className="two-value">"</span>
              <span className="two-value">'</span>
            </Key>
          ...
          <Row>
            ...
            <Key align={true} className="f_key" data-code="Comma" data-val=",">
              <span className="two-value">&lt;</span>
              <span className="two-value">,</span>
            </Key>
            <Key align={true} className="f_key" data-code="Period" data-val=".">
              <span className="two-value">&gt;</span>
              <span className="two-value">.</span>
            </Key>
            <Key align={true} className="f_key" data-code="Slash" data-val="/">
              <span className="two-value">?</span>
              <span className="two-value">/</span>
            </Key>
            <RightShift
